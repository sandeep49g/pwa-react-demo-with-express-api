                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            <div className="d-flex flex-column align-items-center text-center">
                                                <img src={profileImage} alt="Admin" className="rounded-circle" width="150" />
                                                <div className="mt-3">
                                                    <h4>{employeeInfo.name}</h4>
                                                    <p className="text-secondary mb-1">{employeeInfo.designation}</p>
                                                    <p className="text-muted font-size-sm">{employeeInfo.email}</p>
